/*
 * Maturitni otazka c.: 24
 * Nazev: Programování v jazyce Java – rozhraní a polymorfizmus
 * Zadani:
    * Konstrukce rozhraní (interface), použití rozhraní (implements), rozdíly oproti dědičnosti,
    * polymorfi (použití více rozhraní jednou třídou, polymorfizmus pomocí dědičnosti nebo rozhraní
...
class Kolo implements Prostredek, Motor{
...
class Auto implements Prostredek, Motor{
...
public class MO24 {
    public static void main(String[] args) {
        ...
        System.out.println(kolo2.maMotor());
